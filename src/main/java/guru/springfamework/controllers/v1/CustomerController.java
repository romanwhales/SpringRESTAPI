...
public class CustomerController {
    ...
    @ApiOperation(value = "This will get a list of customers",notes="These " +
            "are some notes about the API")
    @GetMapping
    ...
    public ResponseEntity<CustomerDTO> patchCustomer(@PathVariable Long id,
                                                      @RequestBody CustomerDTO customerDTO){
        return new ResponseEntity<CustomerDTO>(customerService.patchCustomer(id,
                customerDTO),
                HttpStatus.OK);
    }
